...
public class Log {
    ...
    private static void logInfo(String msg) {
        log.info("["+OtherGrowth.pluginName+":"+OtherGrowth.pluginVersion+"] "+msg);
    }
    ...
    static void logWarning(String msg) {
        log.warning("["+OtherGrowth.pluginName+":"+OtherGrowth.pluginVersion+"] "+msg);
    }
    ...
    public static void setConfigVerbosity(Plugin plugin, String string) {
        File global = new File(plugin.getDataFolder(), string);
        YamlConfiguration globalConfig = YamlConfiguration.loadConfiguration(global);
        setConfigVerbosity(globalConfig);
    }
}
