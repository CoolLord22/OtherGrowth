...
package com.gmail.zariust.mcplugins.othergrowth.common.data;
...
public class SimpleData implements Data, RangeableData {
    ...
    public void setOn(Entity entity, Player witness) {
        if (!(entity instanceof Painting)) {
            Log.warning("Tried to change a painting, but no painting was found!");
            return;
        }
    ...
    private String get(Material mat) {
        if (mat == null) {
            Log.warning("SimpleData.get() - material is null, this shouldn't happen...");
            return "";
        }
        String result = "";
        try {
            ...
            Log.high(
                    "SimpleData.get - nullpointer exception for material: " + mat.toString());
    ...
    public String toString() {
        ...
        // get method instead
        Log.extreme("SimpleData.toString() was called! Is this right?");
